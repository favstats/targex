...
### Studying online political microtargeting before 2022


+ Poor data access

  + Meta Ad Library Data has many shortcomings (Leerssen et al. 2021)
  
      + no actual targeting criteria
  
  + Google only provides data on few (official) political actors
...
+ Alternatives (?)
  ...
  + only accessible via data donations 
     
      + scarce coverage and biased data
...
### Data on Ad Targeting in 2023

+ September 2022 Meta gives *vetted researchers* access to an "ad targeting dataset"

    + Includes **actual** targeting criteria used in Social Issue, Electoral, and Political (SIEP) ads on the **ad-level**
...
+ The Ad Targeting Dataset released by is a step in the right direction

  + however, the dataset is not easily accessible by civil society
